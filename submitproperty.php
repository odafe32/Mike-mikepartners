...
if(isset($_POST['add']))
{
	...
	$sql="insert into property (title,pcontent,size,client,location,city,state,pimage,pimage1,pimage2,pimage3,pimage4,uid,mapimage,topmapimage,groundmapimage,type)
	values('$title','$content','$asize','$client',
	'$loc','$city','$state','$aimage','$aimage1','$aimage2','$aimage3','$aimage4','$uid','$fimage','$fimage1','$fimage2','$ptype')";
										...
										<div class="row">
											<div class="col-xl-6">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<input type="text" class="form-control" name="ptype" required placeholder="Enter Type">
													</div>
											</div>
