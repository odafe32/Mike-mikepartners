...
?>  
  <div class="header" style="background-color:#fff;">
				...
				<a href="javascript:void(0);" id="toggle_btn" style="background-color:#000;">
				...
				<!-- Mobile Menu Toggle -->
				<a class="mobile_btn" id="mobile_btn" style="background-color:#fff;">
					<i class="fa fa-bars" style="background-color:#fff;"></i>
				</a>
				<!-- /Mobile Menu Toggle -->
