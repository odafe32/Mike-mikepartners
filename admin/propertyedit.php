...
if(isset($_POST['add']))
{
	...
	size='{$asize}', client='{$client}', location='{$loc}', city='{$city}', state='{$state}', 
							...
							<div class="card">
								...
								<div class="card-body">
									<h5 class="card-title">Property Detail</h5>
										...
										<h4 class="card-title">client & Location</h4>
										<div class="row">
											<div class="col-xl-6">
												<div class="form-group row">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<input type="text" class="form-control" name="client" required value="<?php echo $row['13']; ?>">
													</div>
												</div>
												<div class="form-group row">
