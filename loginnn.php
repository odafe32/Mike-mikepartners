...
<div id="page-wrapper">
    <div class="row"> 
        ...
        <!--	Banner   --->
        <div class="banner-full-row page-banner" style="background-image:url('project_img/project3-b.jpg');">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                	...
                	<div class="loginbox">
                        <div class="login-right">
							<div class="login-right-wrap">
								...
								<div class="text-center dont-have">Don't have an account? <a href="registerrr.php">Register</a></div>
