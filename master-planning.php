    ...
    <div class="row"> 
        ...
        <div class="banner-full-row page-banner" style="background-image:url('project_img/project4-b.jpg');">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <h2 class="page-name float-left text-white text-uppercase mt-1 mb-0" style="font-weight:600; text-transform:uppercase; fonts  font-family: 'Roboto', sans-serif;'">Master Planning</h2>
                    </div>
                    <div class="col-md-6">
      ...
      <div class="container">
        <div class="row text-left mb-5">
          <div class="col-12">
            <h2 class="font-weight-bold heading text-primary mb-4" >Master Planning</h2>
          </div>
          <div class="col-lg-6">
    <p class="text-black" style="font-weight:400; font-family: 'Roboto', sans-serif;">
    At Mike & Mike Partners, our master planning services are focused on creating cohesive and sustainable developments that meet the needs of communities today and in the future. Master planning involves a comprehensive approach to land use, integrating architecture, infrastructure, and community amenities to create vibrant and functional environments.
    </p>
    </p>
    <p class="text-black" style="font-weight:400; font-family: 'Roboto', sans-serif;">
    Sustainability is at the core of our master planning philosophy. We design developments that promote environmental stewardship, economic viability, and social well-being. This includes incorporating green spaces, efficient transportation networks, and sustainable building practices that reduce the environmental footprint.
    </p>
    </p>
...
<div class="col-lg-6">
    <p class="text-black" style="font-weight:400; font-family: 'Roboto', sans-serif;">
    Innovation is a key aspect of our master planning services. We leverage the latest technologies and design trends to create smart, resilient, and future-proof developments. This includes the integration of smart infrastructure, renewable energy sources, and sustainable water management systems.
    </p>
    </p>
    <p class="text-black" style="font-weight:400; font-family: 'Roboto', sans-serif;">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-4 mt-lg-5" data-aos="fade-up" data-aos-delay="100">
            <img src="project_img/project3-b.jpg" alt="Image" class="img-fluid" />
          </div>
          <div class="col-md-4" data-aos="fade-up" data-aos-delay="200">
            <img src="project_img/project3-c.jpg" alt="Image" class="img-fluid" />
          </div>
        </div>
