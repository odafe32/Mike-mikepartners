    ...
    <div class="row"> 
        ...
        <div class="banner-full-row page-banner" style="background-image:url('project_img/project4-b.jpg');">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <h2 class="page-name float-left text-white text-uppercase mt-1 mb-0" style="font-weight:600; text-transform:uppercase; fonts  font-family: 'Roboto', sans-serif;'">Architectural Design</h2>
                    </div>
                    <div class="col-md-6">
      ...
      <div class="container">
        <div class="row text-left mb-5">
          <div class="col-12">
            <h2 class="font-weight-bold heading text-primary mb-4" >Architectural Design</h2>
          </div>
          <div class="col-lg-6">
    <p class="text-black" style="font-weight:400; font-family: 'Roboto', sans-serif;">
    splits across four levels, marrying contemporary design practices and space planning with clear design drivers: an environment that is fun, quirky and gives back to the users, an environment that is professional yet entertaining - promoting social interaction throughout the entire fit out.
    </p>
    <p class="text-black" style="font-weight:400; font-family: 'Roboto', sans-serif;">
    Key objectives include the increased interaction between the users which lead to the implementation of a central interconnecting courtyard to promote communal activities. The centre is designed to the international standards, ideal for grand social functions, banquets, and a variety of events.
    </p>
 
</div>
<div class="col-lg-6">
    <p class="text-black" style="font-weight:400; font-family: 'Roboto', sans-serif;">
    Our architectural design approach ensures that every project meets the highest standards of excellence and sustainability. We integrate innovative solutions and cutting-edge technology to create spaces that are not only visually stunning but also functional and efficient.
    </p>
    <p class="text-black" style="font-weight:400; font-family: 'Roboto', sans-serif;">
    We collaborate closely with our clients to understand their vision and requirements, delivering bespoke designs that reflect their unique identity and aspirations. Our team of skilled architects and designers is dedicated to pushing the boundaries of creativity and delivering projects that inspire and elevate the human experience.
    </p>
    </p>
</div>
        ...
        <div class="row justify-content-between mb-5">
          <div class="col-lg-7 mb-5 mb-lg-0">
            <div class="img-about dots">
              <img src="project_img/project7-a.jpg" alt="Image" class="img-fluid" />
            </div>
          </div>
          <div class="col-lg-4">
            <div class="d-flex feature-h">
              ...
              <div class="feature-text">
                ...
                Our architectural services include comprehensive project management from concept to completion. We handle every aspect of the project, ensuring seamless coordination and execution. Our team works closely with clients to understand their vision and deliver bespoke solutions that exceed expectations.
             
                </p>

                <p>  Our design philosophy emphasizes the importance of understanding the context and environment in which a building exists. We believe in harmonizing the built environment with its natural surroundings, creating designs that respect and enhance their location.</p>
              </div>
            </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-4 mt-lg-5" data-aos="fade-up" data-aos-delay="100">
            <img src="project_img/project7-b.jpg" alt="Image" class="img-fluid" />
          </div>
          <div class="col-md-4" data-aos="fade-up" data-aos-delay="200">
            <img src="project_img/project7-c.jpg" alt="Image" class="img-fluid" />
          </div>
        </div>
